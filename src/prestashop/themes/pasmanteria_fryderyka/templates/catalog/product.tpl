            ...
            <ul>
              <li>
                <div class="block-reassurance-item">
                  <img src="/img/custom/blockreassurance/verfied_user.png"
                       alt="Polityka bezpieczeństwa 
Chronimy i przetwarzamy Twoje dane osobowe. Polityka prywatności zgodna z RODO.Więcej informacji w zakładce &quot; Polityka prywatności&quot;">
                  <span class="h6">Polityka bezpieczeństwa
                    Chronimy i przetwarzamy Twoje dane osobowe. Polityka prywatności zgodna z RODO.Więcej informacji w
                    zakładce " Polityka prywatności"</span>
                </div>
              </li>
              <li> 
                <div class="block-reassurance-item">
                  <img src="/img/custom/blockreassurance/free_shipping.png"
                       alt="Darmowa dostawa powyżej 200 zł ">
                  <span class="h6">Darmowa dostawa powyżej 200 zł </span>
                </div>
              </li>
              <li>
                <div class="block-reassurance-item">
                  <img src="/img/custom/blockreassurance/swap.png"
                       alt="Kliencie masz 14 dni na zwrot lub wymianę zakupionego u nas towaru">
                  <span class="h6">Kliencie masz 14 dni na zwrot lub wymianę zakupionego u nas towaru</span>
                </div>
              </li>
            </ul>
          </div>
    ...
    {hook h='displayCategoryProducts' product=$product}
